...
(function seedJuniorNationalsV3(){
  ...
  const UPDATED="2026-06-08T18:00:00.000Z";
  ...
  const DATA=[
    ...
    ["B","2026-07-29","jn-v3-day-02-open-training","Junior Nationals open training - first third of day",390,210,"Junior Nationals open training before the first competition block."],
    ["S","2026-07-29","jn-v3-session-01","Session V3-1 - A/B Prelims",600,55,[["Group B","Boys","1m","Individual","Prelim",9,40,35,1,3,""],["Group A","Boys","3m","Individual","Prelim",10,42,35,1,3,""],["Group A","Girls","Platform","Individual","Prelim",8,42,32.14,0,0,""]]],
    ["S","2026-07-29","jn-v3-session-02","Session V3-2 - A/B Finals",900,35,[["Group B","Boys","1m","Individual","Final",4,12,35,0,0,""],["Group A","Boys","3m","Individual","Final",5,12,35,0,0,""],["Group A","Girls","Platform","Individual","Final",4,12,45,0,0,""]]],
    ...
    ["S","2026-07-30","jn-v3-session-04","Session V3-4 - A/B Finals",780,35,[["Group A","Boys","1m","Individual","Final",5,12,35,0,0,""],["Group B","Girls","3m","Individual","Final",3,12,35,0,0,""],["Group B","Boys","Platform","Individual","Final",4,12,45,0,0,""]]],
    ["S","2026-07-31","jn-v3-session-05","Session V3-5 - A/B Prelims",450,55,[["Group B","Girls","1m","Individual","Prelim",8,42,35,1,3,""],["Group A","Girls","3m","Individual","Prelim",9,42,35,1,3,""],["Group A","Boys","Platform","Individual","Prelim",9,42,33.33,0,0,""]]],
    ["S","2026-07-31","jn-v3-session-06","Session V3-6 - C/D Prelims",760,55,[["Group C","Boys","1m","Individual","Prelim",8,36,35,1,3,""],["Group D","Boys","3m","Individual","Prelim",6,27,35,0,0,""],["Group D","Girls","Platform","Individual","Prelim",6,34,30,0,0,""]]],
    ["S","2026-07-31","jn-v3-session-07","Session V3-7 - A/B Finals",930,35,[["Group B","Girls","1m","Individual","Final",3,12,35,0,0,""],["Group A","Girls","3m","Individual","Final",4,12,35,0,0,""],["Group A","Boys","Platform","Individual","Final",5,12,45,0,0,""]]],
    ["S","2026-07-31","jn-v3-session-08","Session V3-8 - C/D Finals",1035,35,[["Group C","Boys","1m","Individual","Final",4,12,35,0,0,""],["Group D","Boys","3m","Individual","Final",3,12,35,0,0,""],["Group D","Girls","Platform","Individual","Final",3,12,45,0,0,""]]],
    ["S","2026-08-01","jn-v3-session-09","Session V3-9 - A/B Prelims",450,55,[["Group A","Girls","1m","Individual","Prelim",9,42,35,1,3,""],["Group B","Boys","3m","Individual","Prelim",9,39,35,1,3,""],["Group B","Girls","Platform","Individual","Prelim",7,40,34.29,0,0,""]]],
    ["S","2026-08-01","jn-v3-session-10","Session V3-10 - C/D Prelims",740,55,[["Group D","Girls","1m","Individual","Prelim",6,34,35,1,2,""],["Group C","Boys","3m","Individual","Prelim",8,36,35,1,3,""],["Group C","Girls","Platform","Individual","Prelim",6,35,36,0,0,""]]],
    ["S","2026-08-01","jn-v3-session-11","Session V3-11 - A/B Finals",900,35,[["Group A","Girls","1m","Individual","Final",4,12,35,0,0,""],["Group B","Boys","3m","Individual","Final",4,12,35,0,0,""],["Group B","Girls","Platform","Individual","Final",3,12,45,0,0,""]]],
    ["S","2026-08-01","jn-v3-session-12","Session V3-12 - C/D Finals",1020,35,[["Group D","Girls","1m","Individual","Final",3,12,35,0,0,""],["Group C","Boys","3m","Individual","Final",4,12,35,0,0,""],["Group C","Girls","Platform","Individual","Final",3,12,45,0,0,""]]],
    ["S","2026-08-02","jn-v3-session-13","Session V3-13 - C/D Prelims",480,55,[["Group C","Girls","1m","Individual","Prelim",7,36,35,1,3,""],["Group D","Girls","3m","Individual","Prelim",6,34,35,1,2,""],["Group D","Boys","Platform","Individual","Prelim",6,34,30,0,0,""]]],
    ["S","2026-08-02","jn-v3-session-14","Session V3-14 - C/D Finals",760,40,[["Group C","Girls","1m","Individual","Final",3,12,35,0,0,""],["Group D","Girls","3m","Individual","Final",3,12,35,0,0,""],["Group D","Boys","Platform","Individual","Final",3,12,45,0,0,""]]],
    ...
    ["S","2026-08-03","jn-v3-session-15","Session V3-15 - C/D Prelims",480,55,[["Group D","Boys","1m","Individual","Prelim",6,36,35,1,2,""],["Group C","Girls","3m","Individual","Prelim",7,35,35,1,3,""],["Group C","Boys","Platform","Individual","Prelim",7,36,30,0,0,""]]],
    ["S","2026-08-03","jn-v3-session-16","Session V3-16 - C/D Finals",760,40,[["Group D","Boys","1m","Individual","Final",3,12,35,0,0,""],["Group C","Girls","3m","Individual","Final",3,12,35,0,0,""],["Group C","Boys","Platform","Individual","Final",4,12,45,0,0,""]]],
    ["S","2026-08-03","jn-v3-session-17","Session V3-17 - 14-18 Synchro Finals",930,60,[["14-18","Girls","3m","Synchronized","Final",5,12,35,0,0,""],["14-18","Boys","Platform","Synchronized","Final",5,12,45,0,0,""]]],
    ...
    ["S","2026-08-04","jn-v3-session-18","Session V3-18 - 14-18 Synchro Finals",570,60,[["14-18","Boys","3m","Synchronized","Final",5,12,35,0,0,""],["14-18","Girls","Platform","Synchronized","Final",5,12,45,0,0,""]]],
  ...
  function findBase(lib){
    ...
    const any=lib.find(x=>x&&x.schedule&&x.schedule.meet);
  ...
  function buildSchedule(base){
    ...
    return {updatedAt:UPDATED,meet:{name:NAME,venue:base?.meet?.venue||"Competition Pool",timezone:base?.meet?.timezone||"America/New_York",meetType:"custom",canvaUrl:base?.meet?.canvaUrl||"",updatedAt:UPDATED,days:dates.map(d=>({id:dayId(d),date:d,openMinutes:390,closeMinutes:1200,locked:false}))},profile:{id:"custom",label:"Custom",description:"Junior Version 3: all same-day prelim sessions are completed before same-day finals, with synchro treated as the exception and clustered at the junior finish/transition window.",allowedRounds:["Qualifier","Prelim","Semifinal","Final","Custom Block","Open Practice"],roundRelationships:[],events:base?.profile?.events||[]},sessions,selectedRound:"Prelim",outputSettings:{publicShowWarmups:true,publicShowOpenPracticeNotes:true,publicPreset:"clean",showEndTimes:true,showSubjectToChange:true},theme:"classic",entryMode:"projected",locks:{entries:false,sessionOrder:false},publishStatus:"review",currentLibraryId:ID,schedulePackageId:ID,scheduleNotes:[{id:"note-version-3-flow",scope:"meet",audience:"operations",text:"Junior Version 3: all prelims for the day are scheduled before finals, except synchro finals. Comp Day 1 begins with open training; A/B finish individual events by Day 4; C/D run Days 3-6; Aug. 4 is senior open training, two junior synchro finals, then National Qualifier open training."}]};
  }
